...
import { useProjects, useMeetingsApi, useActionItems, useProjectPapers, useProjectDependencies, useDecisions, useTasks, useProjectUpdates, useRevisions, useInsightSuggestions } from '../hooks/useApiData'
...
function ProjectDetailInner({ project }: InnerProps) {
  ...
  return (
    <>
      ...
      <RelatedProjectsSection projectSlug={project.slug} />
...
// ── Related Projects Section (AI Insights) ────────────────────

function RelatedProjectsSection({ projectSlug }: { projectSlug: string }) {
