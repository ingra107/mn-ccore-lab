...
// HERMES_PENDING_PLACEHOLDER / isHermesPending moved to ./hermesPendingUtil.ts
// (2026-07-16 lint burndown, #174) — this file's react-refresh contract is
// components-only. Caller: activityRender.tsx.
