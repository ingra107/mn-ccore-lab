                ...
                filtered.map((task) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {task.project_title && (
                        <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--gold)', opacity: 0.6 }}>
                          {task.project_title}
                        </span>
                      )}
                    </div>
                    ...
                    {task.due_date && (
                      <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--slate)', opacity: 0.5, flexShrink: 0 }}>
                        {task.due_date}
                      </span>
                    )}
                  </button>
