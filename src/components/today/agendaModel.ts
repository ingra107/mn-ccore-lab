// agendaModel.ts — Pure data transform for the proportional agenda grid.
//
// GH#80 codex-plan (2026-06-18): Replaces the absolute-canvas model (P1-P4).
// Takes a list of TodayEvent objects and produces an AgendaModel whose units
...
//   - agendaEvents (timed <3h + untimed) → clustered into agendaUnits.
...
export type AgendaUnit = GapUnit | MeetingUnit | OverlapUnit | UntimedUnit
