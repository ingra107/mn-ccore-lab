# Deep Audit — 20260417T21512_02-project-lifecycle
...
- **[PROJ-TASK-NOT-ON-DETAIL] [P1] 2.H linked task on project detail**
  ...
  - Expected: "test_delete_deep_proj_task_vkmgpj" visible
...
══════ SUITE: 02-project-lifecycle (run 20260417T21512_02-project-lifecycle) ══════
Base: https://mn-ccore-lab.pages.dev

━━━ 2.A  Create project via API ━━━
- [PASS] 2.A Project created — slug=test-delete-deep-proj-dh2pkl
...
- [PASS] 2.H Task created linked to project, id=cc47ec1ffb10a6301c92d83c6c0a2bfb
- **[PROJ-TASK-NOT-ON-DETAIL] [P1] 2.H linked task on project detail**
  - Observed: title not found
  - Expected: "test_delete_deep_proj_task_vkmgpj" visible
