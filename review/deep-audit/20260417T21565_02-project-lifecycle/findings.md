# Deep Audit — 20260417T21565_02-project-lifecycle
...
- **[PROJ-TASK-NOT-ON-DETAIL] [P1] 2.H linked task on project detail**
  ...
  - Expected: "test_delete_deep_proj_task_ukhrvr" visible

## Full trace


══════ SUITE: 02-project-lifecycle (run 20260417T21565_02-project-lifecycle) ══════
Base: https://mn-ccore-lab.pages.dev

━━━ 2.A  Create project via API ━━━
- [PASS] 2.A Project created — slug=test-delete-deep-proj-v7pnx5
...
- [PASS] 2.H Task created linked to project, id=d351a3d158b89a1a8f59167c34ff5977
- **[PROJ-TASK-NOT-ON-DETAIL] [P1] 2.H linked task on project detail**
  - Observed: title not found
  - Expected: "test_delete_deep_proj_task_ukhrvr" visible
