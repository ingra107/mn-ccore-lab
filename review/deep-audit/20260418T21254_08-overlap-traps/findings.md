# Deep Audit — 20260418T21254_08-overlap-traps
...
══════ SUITE: 08-overlap-traps (run 20260418T21254_08-overlap-traps) ══════
Base: https://mn-ccore-lab.pages.dev

━━━ 8.A  Duplicate project title gets distinct slug ━━━
- [PASS] 8.A Distinct slugs generated: overlap-trap-acltd5 vs overlap-trap-acltd5-2

━━━ 8.B  Explicit duplicate slug in payload — server must prevent collision ━━━
- [PASS] 8.B Server side-stepped collision: returned slug=overlap-trap-acltd5-3 instead of overlap-trap-acltd5
...
- [PASS] 8.I All 4 rapid status changes accepted
  8.I final status: todo (any of in_progress/done/todo/blocked acceptable)
