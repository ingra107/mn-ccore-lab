# Deep Audit — 20260418T20553_01-task-lifecycle

Base: https://mn-ccore-lab.pages.dev
Screenshots: 6
PASS: 26
Bugs: 4 (P0 2, P1 1, P2 1)

## Bugs

- **[TASK-PATCH-ASSIGNEE] [P0] 1.F POST assignee=mesfin**
  - Observed: HTTP 400
  - Expected: 200
...
══════ SUITE: 01-task-lifecycle (run 20260418T20553_01-task-lifecycle) ══════
Base: https://mn-ccore-lab.pages.dev

━━━ 1.A  Create task via API — full payload ━━━
- [PASS] 1.A Task created via API — id=4c2d82cec7a23c2a29f05ec82ff0d76e
