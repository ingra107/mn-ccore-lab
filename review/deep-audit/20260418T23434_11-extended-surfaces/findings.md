# Deep Audit — 20260418T23434_11-extended-surfaces

Base: https://mn-ccore-lab.pages.dev
Screenshots: 0
PASS: 16
Bugs: 3 (P0 0, P1 0, P2 3)

## Bugs

- **[DISPATCH-GET] [P2] 11.N GET /api/pb/dispatch/pending**
  - Observed: HTTP 403
  - Expected: 200
- **[SESSIONS-FAIL] [P2] 11.S GET /api/pb/sessions**
  - Observed: HTTP 403
  - Expected: 200/404
- **[BUGREPORT-REACH] [P2] 11.T /api/bug-report reachable**
  - Observed: HTTP 401
  - Expected: 400 (empty body) or 200

## Full trace


══════ SUITE: 11-extended-surfaces (run 20260418T23434_11-extended-surfaces) ══════
Base: https://mn-ccore-lab.pages.dev
...
- [PASS] 11.D Inbox entry 0d2248ba-05e2-4242-be51-57b1ddefaec7 created
...
- [PASS] 11.I Meeting prep for mtg-2026-05-01-7b8a5d94 responds

━━━ 11.J  Digest preview endpoint ━━━
- [PASS] 11.J /api/digest-preview returns HTML (8521 bytes)
