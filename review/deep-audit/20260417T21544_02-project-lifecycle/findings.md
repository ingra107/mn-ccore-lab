# Deep Audit — 20260417T21544_02-project-lifecycle
...
- **[PROJ-TASK-NOT-ON-DETAIL] [P1] 2.H linked task on project detail**
  ...
  - Expected: "test_delete_deep_proj_task_hpjbuv" visible
- **[PROJ-DELETE-FAIL] [P1] 2.M POST /api/projects/:slug/delete**
  - Observed: HTTP 500
  - Expected: 200
...
══════ SUITE: 02-project-lifecycle (run 20260417T21544_02-project-lifecycle) ══════
Base: https://mn-ccore-lab.pages.dev

━━━ 2.A  Create project via API ━━━
- [PASS] 2.A Project created — slug=test-delete-deep-proj-1pu1i8
...
- [PASS] 2.H Task created linked to project, id=99eacbe45d0412e089dec0f42bde0c62
- **[PROJ-TASK-NOT-ON-DETAIL] [P1] 2.H linked task on project detail**
  - Observed: title not found
  - Expected: "test_delete_deep_proj_task_hpjbuv" visible
