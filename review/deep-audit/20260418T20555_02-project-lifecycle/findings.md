# Deep Audit — 20260418T20555_02-project-lifecycle
...
- **[PROJ-TASK-NOT-ON-DETAIL] [P1] 2.H linked task on project detail**
  ...
  - Expected: "test_delete_deep_proj_task_6q2rpu" visible

## Full trace


══════ SUITE: 02-project-lifecycle (run 20260418T20555_02-project-lifecycle) ══════
Base: https://mn-ccore-lab.pages.dev

━━━ 2.A  Create project via API ━━━
- [PASS] 2.A Project created — slug=test-delete-deep-proj-7tdbhf
...
- [PASS] 2.H Task created linked to project, id=2b023b0db0b962392187483b22eca2a6
- **[PROJ-TASK-NOT-ON-DETAIL] [P1] 2.H linked task on project detail**
  - Observed: title not found
  - Expected: "test_delete_deep_proj_task_6q2rpu" visible
