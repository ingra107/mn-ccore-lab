# Deep Audit — 20260419T19392_11-extended-surfaces
...
══════ SUITE: 11-extended-surfaces (run 20260419T19392_11-extended-surfaces) ══════
Base: https://mn-ccore-lab.pages.dev
...
- [PASS] 11.D Inbox entry aa3301ba-8b4b-4565-8334-7ddf1147c4b4 created
...
━━━ 11.G  Daily plan endpoint ━━━
  11.G INFO: no daily plan for 2026-04-19 (may not exist)
...
- [PASS] 11.I Meeting prep for mtg-2026-05-01-415b9459 responds

━━━ 11.J  Digest preview endpoint ━━━
- [PASS] 11.J /api/digest-preview returns HTML (9512 bytes)
...
- [PASS] 11.M /api/email-drafts returns 123 drafts

━━━ 11.N  Dispatch queue endpoint (/api/pb/dispatch/pending) ━━━
- [PASS] 11.N /api/pb/dispatch/pending returns 403 to non-PI (PI gate)
...
- [PASS] 11.Q /api/publications returns 66 publications
...
- [PASS] 11.S /api/pb/sessions returns 403 to non-PI (PI gate)

━━━ 11.T  Bug report endpoint (validates GitHub token available) ━━━
- [PASS] 11.T /api/bug-report returns 401 to unauth callers (auth required)
