...
══════ SECTION C-entities/C1-task (desktop/dark) — run 20260422T05423 ══════
Base: https://mn-ccore-lab.pages.dev
C1 — task lifecycle
C1.1 Create task via CreateTaskModal
- [PASS] C1.1 modal opens with data-testid
- [PASS] C1.1 task row appears in list (_TEST_DELETE_c1task_mo9mzokq_nbb7)
  created task id=6ad1f7575be6…
