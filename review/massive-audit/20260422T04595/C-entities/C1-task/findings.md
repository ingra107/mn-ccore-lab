...
══════ SECTION C-entities/C1-task (desktop/dark) — run 20260422T04595 ══════
Base: https://mn-ccore-lab.pages.dev
C1 — task lifecycle
C1.1 Create task via CreateTaskModal
- [PASS] C1.1 modal opens with data-testid
- [PASS] C1.1 task row appears in list (_TEST_DELETE_c1task_mo9lgyb1_msi2)
  created task id=c77b0f0aa750…
...
- [PASS] C1.4 API reflects due_date=2026-04-23
