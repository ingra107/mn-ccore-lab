...
- **[C1.4.1] [P1] due_date API readback**
  - Observed: actual=2026-04-22
  - Expected: 2026-04-23
- **[C1.5.2] [P1] assignee option in listbox**
...
══════ SECTION C-entities/C1-task (desktop/dark) — run 20260422T04452 ══════
Base: https://mn-ccore-lab.pages.dev
C1 — task lifecycle
C1.1 Create task via CreateTaskModal
- [PASS] C1.1 modal opens with data-testid
- [PASS] C1.1 task row appears in list (_TEST_DELETE_c1task_mo9kkhx6_fh5u)
  created task id=568a0636ad85…
...
- [BUG] [C1.5.2] [P1] assignee option in listbox
