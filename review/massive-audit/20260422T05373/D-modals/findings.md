...
══════ SECTION D-modals (desktop/dark) — run 20260422T05373 ══════
Base: https://mn-ccore-lab.pages.dev
D — CreateTaskModal
...
D — CommandPalette
- [PASS] D CommandPalette renders dialog
- [PASS] D CommandPalette Escape closes
D — ShortcutHelp
- [PASS] D ShortcutHelp renders dialog
- [PASS] D ShortcutHelp Escape closes
