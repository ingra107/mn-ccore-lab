...
══════ SECTION C-entities/C1-task (desktop/dark) — run 20260422T04473 ══════
Base: https://mn-ccore-lab.pages.dev
C1 — task lifecycle
C1.1 Create task via CreateTaskModal
- [PASS] C1.1 modal opens with data-testid
- [PASS] C1.1 task row appears in list (_TEST_DELETE_c1task_mo9knb40_1272)
  created task id=8a6cfe17cadd…
