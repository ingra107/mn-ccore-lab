# Pre-flight Run 20260418T20431

**Target:** https://mn-ccore-lab.pages.dev
**Completed:** 2026-04-18T20:46:40.018Z
**Elapsed:** 3m 27s total across 7 personas

## Launch gate: 🟢 GREEN

- ✓ **76** passes across 7 personas
- 🔥 **P0:** 0 (clean)
- ❌ **P1:** 0 (within gate)
- ⚠ **P2:** 10
- ℹ **INFO:** 0
...
| collaborator | Mesfin — Monday-morning catchup | 10 | 0 | 0 | 1 | 0 | 27s |
| coordinator | Research coordinator — heavy data entry | 14 | 0 | 0 | 1 | 0 | 20s |
| trainee | Student/mentee — limited access | 8 | 0 | 0 | 2 | 0 | 28s |
| mobile | iPhone 12 @ 375×812 | 8 | 0 | 0 | 1 | 0 | 38s |
| accessibility | Keyboard-only + screen reader | 9 | 0 | 0 | 2 | 0 | 33s |
