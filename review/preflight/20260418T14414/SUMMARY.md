# Pre-flight Run 20260418T14414

**Target:** https://mn-ccore-lab.pages.dev
**Completed:** 2026-04-18T14:45:12.325Z
**Elapsed:** 3m 24s total across 7 personas

## Launch gate: 🟢 GREEN

- ✓ **71** passes across 7 personas
- 🔥 **P0:** 0 (clean)
- ❌ **P1:** 2 (within gate)
- ⚠ **P2:** 13
- ℹ **INFO:** 0

**Decision criteria:** P0=0 AND P1<3 → green. Current: P0=0, P1=2 → GREEN.

## Per-persona summary

| Persona | Role | Pass | P0 | P1 | P2 | INFO | Time |
|---------|------|------|----|----|----|------|------|
| pi-power-user | Nick — daily power user | 15 | 0 | 0 | 3 | 0 | 30s |
...
| mobile | iPhone 12 @ 375×812 | 6 | 0 | 1 | 2 | 0 | 38s |
| accessibility | Keyboard-only + screen reader | 6 | 0 | 1 | 4 | 0 | 33s |
...
- **accessibility** (Keyboard-only + screen reader): 6 check(s) passed, 5 finding(s)
