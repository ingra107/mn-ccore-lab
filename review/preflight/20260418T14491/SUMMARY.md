# Pre-flight Run 20260418T14491

**Target:** https://mn-ccore-lab.pages.dev
**Completed:** 2026-04-18T14:52:43.508Z
**Elapsed:** 3m 26s total across 7 personas

## Launch gate: 🟢 GREEN

- ✓ **72** passes across 7 personas
- 🔥 **P0:** 0 (clean)
- ❌ **P1:** 1 (within gate)
- ⚠ **P2:** 13
- ℹ **INFO:** 0

**Decision criteria:** P0=0 AND P1<3 → green. Current: P0=0, P1=1 → GREEN.

## Per-persona summary

| Persona | Role | Pass | P0 | P1 | P2 | INFO | Time |
|---------|------|------|----|----|----|------|------|
| pi-power-user | Nick — daily power user | 15 | 0 | 0 | 3 | 0 | 32s |
| collaborator | Mesfin — Monday-morning catchup | 10 | 0 | 0 | 1 | 0 | 26s |
| coordinator | Research coordinator — heavy data entry | 14 | 0 | 0 | 1 | 0 | 20s |
| trainee | Student/mentee — limited access | 8 | 0 | 0 | 2 | 0 | 27s |
| mobile | iPhone 12 @ 375×812 | 6 | 0 | 1 | 2 | 0 | 38s |
| accessibility | Keyboard-only + screen reader | 7 | 0 | 0 | 4 | 0 | 33s |
