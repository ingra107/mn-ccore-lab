...
const HERO_PAGES: PageCapture[] = [
  { slug: '00-home-public',           path: P.home },
  { slug: '01-dashboard',             path: P.dashboard },
  { slug: '02-personal',              path: P.personal },
  { slug: '03-my-tasks',              path: P.myTasks },
  { slug: '04-calendar',              path: P.calendar },
  { slug: '05-deadlines',             path: P.deadlines },
  ...
  { slug: '09-ideas',                 path: P.ideas },
  { slug: '10-decisions',             path: P.decisions },
  { slug: '11-digest',                path: P.digest },
  { slug: '12-grants',                path: P.grants },
  { slug: '13-meetings',              path: P.meetings },
  ...
  { slug: '21-team-member-public',    path: P.publicMember('nick-ingraham') },
  { slug: '22-publications',          path: P.publications },
  ...
  { slug: '30-narratives',            path: P.narratives },
  { slug: '31-search',                path: P.search },
