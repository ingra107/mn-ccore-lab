...
-- ============================================================================
INSERT INTO hub_decisions (id, title, context, rationale, outcome, outcome_status, tags, decided_by, created_at) VALUES
...
INSERT INTO activity_log (id, type, description, related_id, related_type, actor, timestamp) VALUES
  ...
  ('test_delete_act_005', 'hub_decisions', 'test_delete_Logged decision — Use PSM for LTVV analysis', 'test_delete_dec_ltvv_psm', 'decision', 'nick', datetime('now','-20 days')),
  ...
  ('test_delete_act_011', 'hub_decisions', 'test_delete_Logged decision — Target AJRCCM for LTVV', 'test_delete_dec_target_ajrccm', 'decision', 'nick', datetime('now','-15 days')),
  ...
  ('test_delete_act_014', 'hub_decisions', 'test_delete_Logged decision — Exclude trauma from P/F analysis', 'test_delete_dec_exclude_trauma', 'decision', 'shyu', datetime('now','-25 days')),
  ...
  ('test_delete_act_018', 'hub_decisions', 'test_delete_Logged decision — Delay CLIF v3 to June', 'test_delete_dec_clif_v3_timeline', 'decision', 'nick', datetime('now','-8 days')),
  ...
  ('test_delete_act_026', 'hub_decisions', 'test_delete_Logged decision — Rotate fellows across projects', 'test_delete_dec_trainee_rotation', 'decision', 'nick', datetime('now','-40 days')),
  ...
  ('test_delete_act_029', 'hub_decisions', 'test_delete_Logged decision — Author order vasopressor paper', 'test_delete_dec_author_order', 'decision', 'nick', datetime('now','-12 days')),
  ...
  ('test_delete_act_038', 'hub_decisions', 'test_delete_Logged decision — Consolidate CLIF IRBs', 'test_delete_dec_irb_consolidation', 'decision', 'eddington', datetime('now','-50 days')),
  ...
  ('test_delete_act_042', 'hub_decisions', 'test_delete_Logged decision — Move to biweekly lab meetings', 'test_delete_dec_meeting_cadence', 'decision', 'nick', datetime('now','-70 days')),
