...
INSERT INTO activity_log (id, type, description, related_id, related_type, actor, timestamp) VALUES
  ...
  ('test_delete_act_003', 'idea_create', 'test_delete_Submitted new idea — ECMO flows to CLIF v3.1', 'test_delete_idea_ecmo_data', 'idea', 'eddington', datetime('now','-10 days')),
  ...
  ('test_delete_act_006', 'task_update', 'test_delete_Updated task priority to urgent', 'test_delete_task_casey_redcap', 'task', 'eddington', datetime('now','-1 days')),
  ...
  ('test_delete_act_009', 'idea_create', 'test_delete_Submitted new idea — Vasopressor protocol', 'test_delete_idea_vaso_protocol', 'idea', 'shyu', datetime('now','-3 days')),
  ...
  ('test_delete_act_012', 'task_update', 'test_delete_Moved CCI cohort task to in_progress', 'test_delete_task_casey_cci', 'task', 'eddington', datetime('now','-2 days')),
  ('test_delete_act_013', 'idea_create', 'test_delete_Submitted new idea — ML ventilator weaning', 'test_delete_idea_ml_weaning', 'idea', 'shyu', datetime('now','-14 days')),
  ...
  ('test_delete_act_015', 'idea_vote', 'test_delete_Voted on journal club format change', 'test_delete_idea_jc_format', 'idea', 'shyu', datetime('now','-2 days')),
  ...
  ('test_delete_act_020', 'task_update', 'test_delete_Reviewed Dudley grant material', 'test_delete_task_dan_review', 'task', 'shyu', datetime('now','-1 days')),
  ...
  ('test_delete_act_025', 'idea_create', 'test_delete_Submitted idea — Onboarding checklist', 'test_delete_idea_onboarding_doc', 'idea', 'eddington', datetime('now','-1 days')),
  ...
  ('test_delete_act_031', 'regulatory', 'test_delete_GDMS IRB marked expiring soon', 'test_delete_reg_gdms_irb', 'regulatory', 'eddington', datetime('now','-7 days')),
  ...
  ('test_delete_act_033', 'task_create', 'test_delete_Created task — CCI cohort counts', 'test_delete_task_casey_cci', 'task', 'shyu', datetime('now','-3 days')),
  ...
  ('test_delete_act_043', 'task_update', 'test_delete_Analysis re-run scheduled', 'test_delete_task_dan_analysis', 'task', 'shyu', datetime('now','-2 days')),
