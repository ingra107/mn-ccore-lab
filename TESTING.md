...
## Test Suites (API vitest + 4 Playwright suites)

> **Never quote a count from this file — run `npm run test:api`.** (1176 on 2026-07-22; the previous hint here said 848 and was ~4 months stale.)
