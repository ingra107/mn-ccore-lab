...
| Data | TanStack Query v5 + Cloudflare D1 (77 tables, sqlite_master excl. internal; 231 registered routes via Hono — pinned by the route-contract test) + Recharts |
